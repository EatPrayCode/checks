    ...
    if (this.form.valid) {
      ...
      this.notificationService.info(
        (this.form.value.requestGift
          ? this.translate.instant('projectx.examples.form.text4')
          : this.translate.instant('projectx.examples.form.text5')) +
          ' : ' +
          this.translate.instant('projectx.examples.form.text6')
      );
    }
  }
