...
@Component({
  selector: 'projectx-host-for-test',
  template: ''
})
class HostComponent {
  actionHandler = () => {};
...
describe('BigInputActionComponent', () => {
  ...
  it('should be created', () => {
    const template = '<projectx-big-input-action></projectx-big-input-action>';
  ...
  it('should disable button if disabled property is set', () => {
    const template =
      '<projectx-big-input-action [disabled]="true"></projectx-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should display icon if fontSet and fontIcon properties are set', () => {
    const template =
      '<projectx-big-input-action fontSet="fas" fontIcon="fa-trash"></projectx-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should display label with provided text when label property is set', () => {
    const template =
      '<projectx-big-input-action label="delete"></projectx-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should emit action event on button click', () => {
    const template =
      '<projectx-big-input-action (action)="actionHandler()"></projectx-big-input-action>';
    fixture = createHostComponent(template);
