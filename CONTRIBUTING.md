...
we use the git commit messages to **generate the [change log](https://github.com/tomastrajan/project-x/blob/master/CHANGELOG.md)**.
...
Even more [examples](https://github.com/tomastrajan/project-x/commits/master) of commit messages from commit history of this project.
